...
Zulassungen_Bestandteile_Komponenten <- inner_join(Bestandteile_Komponenten,Zulassungen_column_renamed, by="ID_Fahrzeug")%>% 
  select(ID_T21, ID_Schaltung, Fehlerhaft_T21, Fehlerhaft_T21_Datum, Fehlerhaft_Schaltung, Fehlerhaft_Schaltung_Datum, ID_Fahrzeug, Gemeinde=Gemeinden, Zulassung)

# jedem Fahrzeug inklusive Zulassung werden die Geodaten dieser Zulassung zugeordnet
Geodaten_Zulassung_Bestandteile_Komponenten <- left_join(Zulassungen_Bestandteile_Komponenten, Geodaten, by="Gemeinde") %>% 
  select(ID_T21, ID_Schaltung, Fehlerhaft_T21, Fehlerhaft_T21_Datum, Fehlerhaft_Schaltung, Fehlerhaft_Schaltung_Datum, ID_Fahrzeug, Gemeinde, Zulassung, Postleitzahl, Laengengrad, Breitengrad)

# Für die Gemeinde SEEG fehlen die Geodaten, diese müssen deshalb nachgepflegt werden
Geodaten_Zulassung_Bestandteile_Komponenten$Laengengrad[Geodaten_Zulassung_Bestandteile_Komponenten$Gemeinde == "SEEG"] <- "10.6104157" #Laengengrad nachpflegen
Geodaten_Zulassung_Bestandteile_Komponenten$Breitengrad[Geodaten_Zulassung_Bestandteile_Komponenten$Gemeinde == "SEEG"] <- "47.6542215" #Breitengrad nachpflegen
Geodaten_Zulassung_Bestandteile_Komponenten$Postleitzahl[Geodaten_Zulassung_Bestandteile_Komponenten$Gemeinde == "SEEG"] <- "87637"     #PLZ nachpflegen
...
anz_unique_gemeinden <- length(unique(Geodaten_Zulassung_Bestandteile_Komponenten$Gemeinde))
